...
def apply_clahe(image, clipLimit=3.0, tileGridSize=(8,8)):
...
def apply_enhancement(image, kind="CLAHE", **kwargs):
    ...
    if kind in ["BRIGHTNESS", "BC"]:
        return apply_brightness_contrast(image, brightness=kwargs.get("brightness",0), contrast=kwargs.get("contrast",0))
